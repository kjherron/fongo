 ...
 */
/*
 * Copied from com.mongodb.connection.BulkWriteBatchCombiner -- kjherron
 */
public class WongoBulkWriteBatchCombiner {
     ...
     */
    public WongoBulkWriteBatchCombiner(final ServerAddress serverAddress, final boolean ordered, final WriteConcern writeConcern) {
